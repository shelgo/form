...
let Regex = {
    ...
    validateDateOfBirth:function(val){
     //return /^(0[1-9]|1[0-2])\/((0[1-9]|2\d)|3[0-1])\/(19\d\d|200[0-3])$/.test(val);
       // return /^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4}$/.test(val);
        return (/^(0?[1-9]|1[012])[/-](0?[1-9]|[12][0-9]|3[01])[/-]\d{4}$/).test(val);
    },
    ...
    validateMobile: function(val) {
      ...
      //return /^[0][1-9]\d{9}$|^[1-9]\d{9}$/.test(val);
    },
